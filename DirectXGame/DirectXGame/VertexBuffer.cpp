...
VertexBuffer::VertexBuffer(void* list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code, UINT size_byte_shader, RenderSystem* system, bool isTextured):m_buffer(0),m_layout(0), m_system(system)
{
